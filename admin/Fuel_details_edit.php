...
<p>&nbsp;Fuel_name:
  ...
  <p>&nbsp;Fuel_type:
    <input name="fuel_type" class="validate[required] form-control" type="text" id="fuel_type" value="<?php echo $row['Fuel_type'];?>">
  </p>
  <p>&nbsp;Fuel_amount:
    <input name="fuel_amount"  class="validate[required,double] form-control" type="text" id="fuel_amount" value="<?php echo $row['Fuel_amount'];?>">
  </p>
  <p>
