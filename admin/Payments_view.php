                        ...
                        <table id="example1" class="table table-bordered table-striped table-hover">
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        <td><?php echo $sl++; ?></td>
                                        <td><?php echo htmlspecialchars($row['User_request_id']); ?></td>
                                        <td><?php echo htmlspecialchars($row['Payment_amount']); ?></td>
                                        <td><?php echo htmlspecialchars($row['Payment_transaction_no']); ?></td>
                                        <td><?php echo htmlspecialchars($row['Payment_date']); ?></td>
                                        <td><a href="Invoice.php?payment_id=<?php echo $row['Payment_id']; ?>" class="btn btn-primary">Generate Invoice</a></td> <!-- Invoice link -->
                                    </tr>
                                <?php
                                }
                                ?>
