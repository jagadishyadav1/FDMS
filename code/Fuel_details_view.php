...
<?php include('header.php'); ?>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Fule Details</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
			<a href="Fuel_details.php" class="btn btn-primary"> + Add New </a>
  ...
  <tr>
    ...
    <td><a href="Fuel_details_edit.php?id=<?php echo $row['Fuel_id'];?>"><i class="fa fa-edit"></i>Edit</a></td>
