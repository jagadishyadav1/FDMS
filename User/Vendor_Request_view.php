                ...
                <div class="box">
                    <div class="box-header">
                        ...
                        <div class="box-tools pull-right">
                            <a href="Vendor_Request.php" class="btn btn-primary btn-lg btn-custom"> + Request Now</a>
                        </div>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                $sql = "SELECT * FROM user_request_details ur, user_details ud, fuel_detail fd 
                                        WHERE ur.User_id = ud.User_id 
                                        AND ur.Fuel_id = fd.Fuel_id 
                                        AND ud.Email_id = '$uname' 
                                        AND ur.Request_status = 'PENDING'";
